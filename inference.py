...
class LLaMA:
    ...
    def text_completion(self, prompts: list[str], temperature: float= 0.6, top_p: float = 0.9, max_gen_len: Optional[int] = None):
        ...
        # Make sure the prompt length is not greater than the maximum sequence length
...
if __name__ == '__main__':
    ...
    # Inference the model
    out_tokens, out_text = model.text_completion(prompts, temperature=0.6, top_p=0.9, max_gen_len=64)
